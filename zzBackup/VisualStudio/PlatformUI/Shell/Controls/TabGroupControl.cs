...
namespace Microsoft.VisualStudio.PlatformUI.Shell.Controls
{
  public class TabGroupControl : GroupControl
  {
    ...
    {
      FrameworkElement.DefaultStyleKeyProperty.OverrideMetadata(typeof (TabGroupControl), (PropertyMetadata) new FrameworkPropertyMetadata((object) typeof (TabGroupControl)));
    }
    ...
    protected override void PrepareContainerForItemOverride(DependencyObject element, object item)
    {
      ...
      ((FrameworkElement) element).SetResourceReference(FrameworkElement.StyleProperty, (object) TabGroupControl.TabItemStyleKey);
    }
