...
namespace Microsoft.VisualStudio.PlatformUI.Shell.Controls
{
    public class DockGroupAdorner : DockAdorner
    {
        ...
        {
            DockGroupAdorner.DockSiteTypeProperty = DependencyProperty.Register("DockSiteType", typeof(DockSiteType), typeof(DockGroupAdorner), new PropertyMetadata((object)DockSiteType.Default));
