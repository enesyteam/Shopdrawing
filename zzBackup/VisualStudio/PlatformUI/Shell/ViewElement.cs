...
namespace Microsoft.VisualStudio.PlatformUI.Shell
{
  public abstract class ViewElement : DependencyObject, ICustomXmlSerializable, IDependencyObjectCustomSerializerAccess
  {
    ...
    public static readonly DependencyProperty AutoHideWidthProperty = DependencyProperty.Register("AutoHideWidth", typeof (double), typeof (ViewElement), (PropertyMetadata) new FrameworkPropertyMetadata((object) 300.0));
    public static readonly DependencyProperty AutoHideHeightProperty = DependencyProperty.Register("AutoHideHeight", typeof (double), typeof (ViewElement), (PropertyMetadata) new FrameworkPropertyMetadata((object) 300.0));
    public static readonly DependencyProperty FloatingWidthProperty = DependencyProperty.Register("FloatingWidth", typeof (double), typeof (ViewElement), (PropertyMetadata) new FrameworkPropertyMetadata((object) 300.0, new PropertyChangedCallback(ViewElement.OnFloatingSizeChanged)));
    public static readonly DependencyProperty FloatingHeightProperty = DependencyProperty.Register("FloatingHeight", typeof (double), typeof (ViewElement), (PropertyMetadata) new FrameworkPropertyMetadata((object) 200.0, new PropertyChangedCallback(ViewElement.OnFloatingSizeChanged)));
    public static readonly DependencyProperty FloatingLeftProperty = DependencyProperty.Register("FloatingLeft", typeof (double), typeof (ViewElement), (PropertyMetadata) new FrameworkPropertyMetadata((object) double.NaN));
    public static readonly DependencyProperty FloatingTopProperty = DependencyProperty.Register("FloatingTop", typeof (double), typeof (ViewElement), (PropertyMetadata) new FrameworkPropertyMetadata((object) double.NaN));
    ...
    public static readonly DependencyProperty DockRestrictionProperty = DependencyProperty.Register("DockRestriction", typeof (DockRestrictionType), typeof (ViewElement), new PropertyMetadata((object) DockRestrictionType.None));
    public static readonly DependencyProperty AreDockTargetsEnabledProperty = DependencyProperty.Register("AreDockTargetsEnabled", typeof (bool), typeof (ViewElement), (PropertyMetadata) new FrameworkPropertyMetadata((object) true));
    public static readonly DependencyProperty MinimumWidthProperty = DependencyProperty.Register("MinimumWidth", typeof (double), typeof (ViewElement), (PropertyMetadata) new FrameworkPropertyMetadata((object) 30.0));
    public static readonly DependencyProperty MinimumHeightProperty = DependencyProperty.Register("MinimumHeight", typeof (double), typeof (ViewElement), (PropertyMetadata) new FrameworkPropertyMetadata((object) 30.0));
    public static readonly DependencyProperty FloatingWindowStateProperty = DependencyProperty.Register("FloatingWindowState", typeof (WindowState), typeof (ViewElement), (PropertyMetadata) new FrameworkPropertyMetadata((object) WindowState.Normal, new PropertyChangedCallback(ViewElement.OnFloatingWindowStateChanged)));
