...
namespace Microsoft.Expression.Framework.PropertyInspector
{
  ...
  {
    public static readonly DependencyProperty OwningPropertyInspectorModelProperty = DependencyProperty.RegisterAttached("OwningPropertyInspectorModel", typeof (IPropertyInspector), typeof (PropertyInspectorHelper), (PropertyMetadata) new FrameworkPropertyMetadata(null, FrameworkPropertyMetadataOptions.Inherits));
    public static readonly DependencyProperty OwningPropertyInspectorElementProperty = DependencyProperty.RegisterAttached("OwningPropertyInspectorElement", typeof (UIElement), typeof (PropertyInspectorHelper), (PropertyMetadata) new FrameworkPropertyMetadata(null, FrameworkPropertyMetadataOptions.Inherits));
