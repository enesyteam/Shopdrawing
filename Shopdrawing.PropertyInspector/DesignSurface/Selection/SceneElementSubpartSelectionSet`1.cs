...
// Type: Microsoft.Expression.DesignSurface.Selection.SceneElementSubpartSelectionSet`1
...
{
  public class SceneElementSubpartSelectionSet<T> : SubpartSelectionSet<T, MarkerBasedSceneNodeCollection<T>> where T : SceneNode, ISceneElementSubpart
  {
