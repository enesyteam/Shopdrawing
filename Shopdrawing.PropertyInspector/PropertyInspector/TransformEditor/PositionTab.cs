  ...
  public sealed class PositionTab : Grid, ITransformEditorTab, IComponentConnector
  {
    ...
    public void UpdatePropertyContainers(TransformPropertyLookup propertyLookup)
    {
      if (propertyLookup.TransformType == TransformType.Transform3D)
      {
        ...
        {
          this.TranslateXEditor.set_PropertyEntry((PropertyEntry) propertyLookup.CreateProperty("TranslationX"));
          this.TranslateYEditor.set_PropertyEntry((PropertyEntry) propertyLookup.CreateProperty("TranslationY"));
          this.TranslateZEditor.set_PropertyEntry((PropertyEntry) propertyLookup.CreateProperty("TranslationZ"));
        }
        else
        {
          this.TranslateXEditor.set_PropertyEntry((PropertyEntry) propertyLookup.CreateProperty("TranslateTransform/OffsetX"));
          this.TranslateYEditor.set_PropertyEntry((PropertyEntry) propertyLookup.CreateProperty("TranslateTransform/OffsetY"));
          this.TranslateZEditor.set_PropertyEntry((PropertyEntry) propertyLookup.CreateProperty("TranslateTransform/OffsetZ"));
        }
      }
      else
      {
        ...
        {
          this.TranslateXEditor.set_PropertyEntry((PropertyEntry) propertyLookup.CreateProperty("TranslateTransform/X"));
          this.TranslateYEditor.set_PropertyEntry((PropertyEntry) propertyLookup.CreateProperty("TranslateTransform/Y"));
        }
        this.TranslateZEditor.set_PropertyEntry((PropertyEntry) null);
      }
    }
