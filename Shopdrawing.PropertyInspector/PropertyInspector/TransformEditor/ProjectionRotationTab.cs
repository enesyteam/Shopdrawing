...
namespace Microsoft.Expression.DesignSurface.UserInterface.PropertyInspector.TransformEditor
{
  ...
  public sealed class ProjectionRotationTab : Grid, ITransformEditorTab, IComponentConnector
  {
    ...
    {
      this.RotateXEditor.set_PropertyEntry((PropertyEntry) propertyLookup.CreateProperty("PlaneProjection.RotationX"));
      this.RotateYEditor.set_PropertyEntry((PropertyEntry) propertyLookup.CreateProperty("PlaneProjection.RotationY"));
      this.RotateZEditor.set_PropertyEntry((PropertyEntry) propertyLookup.CreateProperty("PlaneProjection.RotationZ"));
    }
