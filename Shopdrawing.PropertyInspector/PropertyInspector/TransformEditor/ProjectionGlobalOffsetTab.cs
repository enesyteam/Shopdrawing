...
namespace Microsoft.Expression.DesignSurface.UserInterface.PropertyInspector.TransformEditor
{
  ...
  public sealed class ProjectionGlobalOffsetTab : Grid, ITransformEditorTab, IComponentConnector
  {
    ...
    {
      this.GlobalOffsetXEditor.set_PropertyEntry((PropertyEntry) propertyLookup.CreateProperty("PlaneProjection.GlobalOffsetX"));
      this.GlobalOffsetYEditor.set_PropertyEntry((PropertyEntry) propertyLookup.CreateProperty("PlaneProjection.GlobalOffsetY"));
      this.GlobalOffsetZEditor.set_PropertyEntry((PropertyEntry) propertyLookup.CreateProperty("PlaneProjection.GlobalOffsetZ"));
    }
