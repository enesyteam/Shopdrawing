  ...
  public sealed class RotationTab : Grid, ITransformEditorTab, IComponentConnector
  {
    ...
    public void UpdatePropertyContainers(TransformPropertyLookup propertyLookup)
    {
      ...
      if (propertyLookup.TransformType == TransformType.Transform2D)
      {
        ...
        {
          this.RotationPropertyContainer.set_PropertyEntry((PropertyEntry) propertyLookup.CreateProperty("RotationAngle", attributes));
          this.RotationSpinner.set_PropertyEntry((PropertyEntry) propertyLookup.CreateProperty("RotationAngle", attributes));
        }
        else
        {
          this.RotationPropertyContainer.set_PropertyEntry((PropertyEntry) propertyLookup.CreateProperty("RotateTransform/Angle", attributes));
          this.RotationSpinner.set_PropertyEntry((PropertyEntry) propertyLookup.CreateProperty("RotateTransform/Angle", attributes));
        }
        this.ArcBall.set_PropertyEntry((PropertyEntry) null);
      }
      else
      {
        this.RotationPropertyContainer.set_PropertyEntry((PropertyEntry) null);
        this.RotationSpinner.set_PropertyEntry((PropertyEntry) null);
        this.ArcBall.set_PropertyEntry((PropertyEntry) propertyLookup.CreateProperty("RotationAngles"));
      }
    }
