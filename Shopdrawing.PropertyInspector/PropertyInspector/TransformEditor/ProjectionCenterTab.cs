...
namespace Microsoft.Expression.DesignSurface.UserInterface.PropertyInspector.TransformEditor
{
  ...
  public sealed class ProjectionCenterTab : Grid, ITransformEditorTab, IComponentConnector
  {
    ...
    public void UpdatePropertyContainers(TransformPropertyLookup propertyLookup)
    {
      ...
      this.CenterOfRotationXEditor.set_PropertyEntry((PropertyEntry) propertyLookup.CreateProperty("PlaneProjection.CenterOfRotationX", attributes));
      this.CenterOfRotationYEditor.set_PropertyEntry((PropertyEntry) propertyLookup.CreateProperty("PlaneProjection.CenterOfRotationY", attributes));
      this.CenterOfRotationZEditor.set_PropertyEntry((PropertyEntry) propertyLookup.CreateProperty("PlaneProjection.CenterOfRotationZ", attributes));
    }
