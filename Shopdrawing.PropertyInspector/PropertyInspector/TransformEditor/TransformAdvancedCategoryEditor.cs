...
// Type: Microsoft.Expression.DesignSurface.UserInterface.PropertyInspector.TransformEditor.TransformAdvancedCategoryEditor
...
namespace Microsoft.Expression.DesignSurface.UserInterface.PropertyInspector.TransformEditor
{
  ...
  internal class TransformAdvancedCategoryEditor : SceneNodeCategoryEditor
  {
    ...
    public virtual DataTemplate EditorTemplate
    {
      get
      {
        ...
        dataTemplate.VisualTree = new FrameworkElementFactory(typeof (TransformAdvancedCategoryLayout));
        return dataTemplate;
      }
    }
