...
namespace Microsoft.Expression.DesignSurface.UserInterface.PropertyInspector
{
  ...
  internal abstract class SketchFlowPickerEditor : Grid, INotifyPropertyChanged, IComponentConnector
  {
    ...
    public SketchFlowPickerDisplayItem CurrentItem
    {
      get
      {
        if (this.EditingProperty == null || this.EditingProperty.get_PropertyValue() == null || this.EditingProperty.get_PropertyValue().get_Value() == null)
          return (SketchFlowPickerDisplayItem) null;
        string xamlName = this.EditingProperty.get_PropertyValue().get_Value() as string;
      ...
      set
      {
        ...
        this.editingProperty.get_PropertyValue().set_Value(pickerDisplayItem == null ? (object) (string) null : (object) pickerDisplayItem.XamlName);
      }
    }
    ...
    private MethodInfo ResolveTypeIdMethod(ITypeId typeId, string methodName)
    {
      ...
      int num = method == (MethodInfo) null ? 1 : 0;
      return method;
    }
    ...
    public void InitializeComponent()
    {
      ...
      Application.LoadComponent(this, new Uri("/Microsoft.Expression.DesignSurface;component/userinterface/propertyinspector/complexvalueeditors/sketchflowpickereditor.xaml", UriKind.Relative));
    }
