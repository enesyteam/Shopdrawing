...
namespace Microsoft.Expression.DesignSurface.UserInterface.PropertyInspector
{
  public class PropertyEditingHelper
  {
    ...
    {
      this.OnBeginTransactionCore(commandArgs != null ? (object) commandArgs.InputElement : (object) (IInputElement) null, commandArgs != null ? commandArgs.Parameter : null);
    }
    ...
    {
      this.SwitchPropertyContainerMode(eventArgs, (PropertyContainerEditMode) 0);
    }

    private void OnShowExtendedPopupEditor(object sender, ExecutedRoutedEventArgs eventArgs)
    {
      this.SwitchPropertyContainerMode(eventArgs, (PropertyContainerEditMode) 1);
    }

    private void OnShowExtendedPinnedEditor(object sender, ExecutedRoutedEventArgs eventArgs)
    {
      this.SwitchPropertyContainerMode(eventArgs, (PropertyContainerEditMode) 2);
    }

    private void OnShowDialogEditor(object sender, ExecutedRoutedEventArgs eventArgs)
    {
      this.SwitchPropertyContainerMode(eventArgs, (PropertyContainerEditMode) 3);
    }
