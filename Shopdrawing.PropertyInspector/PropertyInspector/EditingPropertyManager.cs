  ...
  public class EditingPropertyManager
  {
    ...
    public IPropertyInformation CurrentProperty
    {
      ...
      set
      {
        ...
        {
          ((PropertyEntry) this.editingProperty).PropertyName
        })))
        {
          this.editingProperty.SetValue(value.Name);
          if (this.EditingPropertyChanged != null)
            this.EditingPropertyChanged(this, EventArgs.Empty);
    ...
    private void UnhookEditingProperty()
    {
      ...
      this.targetObjectProperty = null;
    }

    private void UpdateFromDataContext()
    {
      this.UnhookEditingProperty();
      PropertyValue propertyValue = this.hostControl.DataContext as PropertyValue;
      ...
      if (singleStep1 != null)
      {
        this.targetNameProperty = (SceneNodeProperty) nodeObjectSetBase.CreateProperty(new PropertyReference(singleStep1), null);
        this.targetNameProperty.PropertyReferenceChanged += new Microsoft.Expression.DesignSurface.Documents.PropertyReferenceChangedEventHandler(this.OnEditingPropertyChanged);
      }
      ...
      if (singleStep2 != null)
      {
        this.targetObjectProperty = (SceneNodeProperty) nodeObjectSetBase.CreateProperty(new PropertyReference(singleStep2), null);
        this.targetObjectProperty.PropertyReferenceChanged += new Microsoft.Expression.DesignSurface.Documents.PropertyReferenceChangedEventHandler(this.OnEditingPropertyChanged);
      }
      this.Rebuild();
    }
    ...
    public void Rebuild()
    {
      ...
      BehaviorTargetedTriggerActionNode triggerActionNode = sceneNodeProperty != null ? sceneNodeProperty.SceneNodeObjectSet.RepresentativeSceneNode as BehaviorTargetedTriggerActionNode : null;
      ...
      if (this.Rebuilt == null)
        return;
      this.Rebuilt(this, EventArgs.Empty);
    }
  }
}
