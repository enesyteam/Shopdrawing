...
namespace Microsoft.Expression.DesignSurface.UserInterface.PropertyInspector
{
  ...
  {
    public static readonly DependencyProperty ExpressionPropertyValueEditorCommandsProperty = DependencyProperty.RegisterAttached("ExpressionPropertyValueEditorCommands", typeof (ExpressionPropertyValueEditorCommands), typeof (ExpressionPropertyValueEditorCommands), (PropertyMetadata) new FrameworkPropertyMetadata(null, FrameworkPropertyMetadataOptions.Inherits));
    ...
    {
      target.SetValue(ExpressionPropertyValueEditorCommands.ExpressionPropertyValueEditorCommandsProperty, value);
    }
  }
}
