...
//      this.ConditionsNodeView = CollectionViewSource.GetDefaultView(this.ConditionNodes);
//    }
...
//      int num1 = behaviorCategory1.BasicPropertyMatchesFilter | this.get_MatchesFilter() ? 1 : 0;
//      behaviorCategory1.BasicPropertyMatchesFilter = num1 != 0;
//      ConditionalExpressionBehaviorCategory behaviorCategory2 = this;
//      int num2 = behaviorCategory2.AdvancedPropertyMatchesFilter | this.get_MatchesFilter() ? 1 : 0;
//      behaviorCategory2.AdvancedPropertyMatchesFilter = num2 != 0;
//      if (!this.get_MatchesFilter() || filter.get_IsEmpty())
//        return;
//      this.Expanded = true;
//    }
...
//        return;
//      using (IEnumerator<PropertyEntry> enumerator = this.ConditionNodes.GetEnumerator())
//      {
...
//          if (entryForCondition.get_PropertyValue().get_SubProperties().get_Count() == 0)
//          {
