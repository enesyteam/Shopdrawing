...
namespace Microsoft.Expression.DesignSurface.UserInterface.PropertyInspector
{
  ...
  public sealed class TransitionEffectPickerPopup : WorkaroundPopup, IComponentConnector
  {
    ...
    public void InitializeComponent()
    {
      ...
      Application.LoadComponent(this, new Uri("/Microsoft.Expression.DesignSurface;component/userinterface/skinediting/transitioneffectpickerpopup.xaml", UriKind.Relative));
    }
