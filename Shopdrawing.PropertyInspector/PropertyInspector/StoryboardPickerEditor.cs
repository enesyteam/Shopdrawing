  ...
  public sealed class StoryboardPickerEditor : Grid, INotifyPropertyChanged, IComponentConnector
  {
    ...
    private void Rebuild()
    {
      ...
      if (sceneNodeProperty != null)
      {
        ...
        this.storyboardsView = CollectionViewSource.GetDefaultView(this.storyboards);
      }
    ...
    public void InitializeComponent()
    {
      ...
      Application.LoadComponent(this, new Uri("/Microsoft.Expression.DesignSurface;component/userinterface/propertyinspector/complexvalueeditors/storyboardpickereditor.xaml", UriKind.Relative));
    }
