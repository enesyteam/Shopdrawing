...
namespace Microsoft.Expression.DesignSurface.UserInterface.PropertyInspector
{
  ...
  public sealed class TextAlignmentEditor : Decorator, IComponentConnector
  {
    ...
    public IEnumerable TextAlignments
    {
      ...
      set
      {
        this.SetValue(TextAlignmentEditor.TextAlignmentsProperty, value);
      }
    }
    ...
    public void InitializeComponent()
    {
      ...
      Application.LoadComponent(this, new Uri("/Microsoft.Expression.DesignSurface;component/userinterface/propertyinspector/complexvalueeditors/textalignmenteditor.xaml", UriKind.Relative));
    }
