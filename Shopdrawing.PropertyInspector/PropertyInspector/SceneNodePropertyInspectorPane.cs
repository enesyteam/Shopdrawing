...
namespace Microsoft.Expression.DesignSurface.UserInterface.PropertyInspector
{
  ...
  public sealed class SceneNodePropertyInspectorPane : Grid, IComponentConnector
  {
    ...
    public static readonly DependencyProperty PropertyContextMenuProperty = DependencyProperty.Register("PropertyContextMenu", typeof (ContextMenu), typeof (SceneNodePropertyInspectorPane), (PropertyMetadata) new FrameworkPropertyMetadata(null, FrameworkPropertyMetadataOptions.None));
    ...
    public int NameColumnWidth
    {
      ...
      set
      {
        this.SetValue(SceneNodePropertyInspectorPane.NameColumnWidthProperty, value);
      }
    }
    ...
    public ContextMenu PropertyContextMenu
    {
      ...
      set
      {
        this.SetValue(SceneNodePropertyInspectorPane.PropertyContextMenuProperty, value);
      }
    }
    ...
    {
      target.SetValue(SceneNodePropertyInspectorPane.InPropertyInspectorProperty, (object) (bool) (value ? 1 : 0));
    }
    ...
    public void InitializeComponent()
    {
      ...
      Application.LoadComponent(this, new Uri("/Microsoft.Expression.DesignSurface;component/userinterface/propertyinspector/scenenodepropertyinspectorpane.xaml", UriKind.Relative));
    }
