  ...
  public sealed class StatePickerEditor : Grid, INotifyPropertyChanged, IComponentConnector
  {
    ...
    public StateInfo CurrentState
    {
      get
      {
        ...
        {
          string stateNameToFind = this.EditingProperty.get_PropertyValue().get_Value() as string;
      ...
      set
      {
        if (this.EditingProperty.get_PropertyValue() == null)
          return;
        this.EditingProperty.get_PropertyValue().set_Value(value.StateName);
      }
    }
    ...
    public void InitializeComponent()
    {
      ...
      Application.LoadComponent(this, new Uri("/Microsoft.Expression.DesignSurface;component/userinterface/propertyinspector/complexvalueeditors/statepickereditor.xaml", UriKind.Relative));
    }
