...
namespace Microsoft.Expression.DesignSurface.UserInterface.PropertyInspector
{
  ...
  public sealed class KeySplineEditor : Grid, INotifyPropertyChanged, IComponentConnector
  {
    ...
    {
      this.Unhook();
      PropertyValue propertyValue = e.NewValue as PropertyValue;
      if (propertyValue == null)
        return;
      this.keySplineProperty = propertyValue.get_ParentProperty() as SceneNodeProperty;
      this.Rebuild();
    }
    ...
    public void InitializeComponent()
    {
      ...
      Application.LoadComponent(this, new Uri("/Microsoft.Expression.DesignSurface;component/userinterface/propertyinspector/categoryeditors/easing/keysplineeditor.xaml", UriKind.Relative));
    }
