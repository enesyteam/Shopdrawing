...
namespace Microsoft.Expression.DesignSurface.UserInterface.PropertyInspector
{
  internal class MaterialsCategoryEditor : SceneNodeCategoryEditor
  {
    ...
    {
      return FileTable.GetImageSource("Resources\\Icons\\Categories\\pane_materials_24x24_off.png");
    }

    public override object GetHighlightedImage(Size size)
    {
      return FileTable.GetImageSource("Resources\\Icons\\Categories\\pane_materials_24x24_on.png");
    }
  }
}
