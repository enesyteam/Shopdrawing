...
namespace Microsoft.Expression.DesignSurface.UserInterface.PropertyInspector
{
  ...
  public sealed class PropertyPickerEditor : Grid, INotifyPropertyChanged, IComponentConnector
  {
    ...
    private void Rebuild(object sender, EventArgs args)
    {
      ...
      {
        this.propertiesView = CollectionViewSource.GetDefaultView(this.contextHelper.Properties);
      ...
      {
        ((DependencyObject) propertyContainer).SetValue(EditingPropertyManager.EditingPropertyManagerProperty, this.contextHelper);
        propertyContainer.set_ActiveEditMode((PropertyContainerEditMode) 2);
      }
    ...
    public void InitializeComponent()
    {
      ...
      Application.LoadComponent(this, new Uri("/Microsoft.Expression.DesignSurface;component/userinterface/propertyinspector/complexvalueeditors/propertypickereditor.xaml", UriKind.Relative));
    }
