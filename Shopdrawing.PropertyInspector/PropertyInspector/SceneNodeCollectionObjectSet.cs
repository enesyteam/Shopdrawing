...
namespace Microsoft.Expression.DesignSurface.UserInterface.PropertyInspector
{
  public class SceneNodeCollectionObjectSet : SceneNodeObjectSetBase
  {
    ...
    {
      SceneNodeCollectionProperty collectionProperty = new SceneNodeCollectionProperty(this, propertyReference, attributes, this.parentProperty.get_PropertyValue());
