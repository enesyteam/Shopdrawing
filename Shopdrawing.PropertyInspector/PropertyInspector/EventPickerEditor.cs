...
namespace Microsoft.Expression.DesignSurface.UserInterface.PropertyInspector
{
  ...
  public sealed class EventPickerEditor : Grid, INotifyPropertyChanged, IComponentConnector
  {
    ...
    public EventInformation CurrentEvent
    {
      ...
      set
      {
        this.editingProperty.SetValue(value.EventName);
      }
    }
    ...
    private void UpdateFromDataContext()
    {
      ...
      if (this.editingValue != null)
        this.editingProperty = (SceneNodeProperty) this.editingValue.get_ParentProperty();
      if (this.editingProperty == null)
        return;
    ...
    public void InitializeComponent()
    {
      ...
      Application.LoadComponent(this, new Uri("/Microsoft.Expression.DesignSurface;component/userinterface/propertyinspector/complexvalueeditors/eventpickereditor.xaml", UriKind.Relative));
    }
