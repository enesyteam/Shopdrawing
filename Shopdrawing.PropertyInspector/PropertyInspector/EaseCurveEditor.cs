...
namespace Microsoft.Expression.DesignSurface.UserInterface.PropertyInspector
{
  ...
  public sealed class EaseCurveEditor : Control, IComponentConnector
  {
    ...
    public static readonly DependencyProperty X1Property = DependencyProperty.Register("X1", typeof (double), typeof (EaseCurveEditor), (PropertyMetadata) new FrameworkPropertyMetadata( 0.0, FrameworkPropertyMetadataOptions.AffectsRender | FrameworkPropertyMetadataOptions.BindsTwoWayByDefault, new PropertyChangedCallback(EaseCurveEditor.PointPropertyChanged)));
    public static readonly DependencyProperty Y1Property = DependencyProperty.Register("Y1", typeof (double), typeof (EaseCurveEditor), (PropertyMetadata) new FrameworkPropertyMetadata(0.0, FrameworkPropertyMetadataOptions.AffectsRender | FrameworkPropertyMetadataOptions.BindsTwoWayByDefault, new PropertyChangedCallback(EaseCurveEditor.PointPropertyChanged)));
    public static readonly DependencyProperty X2Property = DependencyProperty.Register("X2", typeof (double), typeof (EaseCurveEditor), (PropertyMetadata) new FrameworkPropertyMetadata( 1.0, FrameworkPropertyMetadataOptions.AffectsRender | FrameworkPropertyMetadataOptions.BindsTwoWayByDefault, new PropertyChangedCallback(EaseCurveEditor.PointPropertyChanged)));
    public static readonly DependencyProperty Y2Property = DependencyProperty.Register("Y2", typeof (double), typeof (EaseCurveEditor), (PropertyMetadata) new FrameworkPropertyMetadata(1.0, FrameworkPropertyMetadataOptions.AffectsRender | FrameworkPropertyMetadataOptions.BindsTwoWayByDefault, new PropertyChangedCallback(EaseCurveEditor.PointPropertyChanged)));
    ...
    public static readonly DependencyProperty GridBrushProperty = DependencyProperty.Register("GridBrush", typeof (Brush), typeof (EaseCurveEditor), (PropertyMetadata) new FrameworkPropertyMetadata(null, FrameworkPropertyMetadataOptions.AffectsRender, new PropertyChangedCallback(EaseCurveEditor.BrushPropertyChanged)));
    public static readonly DependencyProperty ControlPointBrushProperty = DependencyProperty.Register("ControlPointBrush", typeof (Brush), typeof (EaseCurveEditor), (PropertyMetadata) new FrameworkPropertyMetadata(null, FrameworkPropertyMetadataOptions.AffectsRender, new PropertyChangedCallback(EaseCurveEditor.BrushPropertyChanged)));
    ...
    public ICommand BeginEditCommand
    {
      ...
      set
      {
        this.SetValue(EaseCurveEditor.BeginEditCommandProperty, value);
      }
    }
    ...
    public ICommand CommitEditCommand
    {
      ...
      set
      {
        this.SetValue(EaseCurveEditor.CommitEditCommandProperty, value);
      }
    }
    ...
    public ICommand CancelEditCommand
    {
      ...
      set
      {
        this.SetValue(EaseCurveEditor.CancelEditCommandProperty, value);
      }
    }
    ...
    public double X1
    {
      ...
      set
      {
        this.SetValue(EaseCurveEditor.X1Property, value);
      }
    }
    ...
    public double Y1
    {
      ...
      set
      {
        this.SetValue(EaseCurveEditor.Y1Property, value);
      }
    }
    ...
    public double X2
    {
      ...
      set
      {
        this.SetValue(EaseCurveEditor.X2Property, value);
      }
    }
    ...
    public double Y2
    {
      ...
      set
      {
        this.SetValue(EaseCurveEditor.Y2Property, value);
      }
    }
    ...
    public bool X1IsNinched
    {
      ...
      set
      {
        this.SetValue(EaseCurveEditor.X1IsNinchedProperty, value);
      }
    }
    ...
    public bool Y1IsNinched
    {
      ...
      set
      {
        this.SetValue(EaseCurveEditor.Y1IsNinchedProperty, value);
      }
    }
    ...
    public bool X2IsNinched
    {
      ...
      set
      {
        this.SetValue(EaseCurveEditor.X2IsNinchedProperty, value);
      }
    }
    ...
    public bool Y2IsNinched
    {
      ...
      set
      {
        this.SetValue(EaseCurveEditor.Y2IsNinchedProperty, value);
      }
    }
    ...
    public Brush GridBrush
    {
      ...
      set
      {
        this.SetValue(EaseCurveEditor.GridBrushProperty, value);
      }
    }
    ...
    public Brush ControlPointBrush
    {
      ...
      set
      {
        this.SetValue(EaseCurveEditor.ControlPointBrushProperty, value);
      }
    }
    ...
    public void InitializeComponent()
    {
      ...
      Application.LoadComponent(this, new Uri("/Microsoft.Expression.DesignSurface;component/userinterface/propertyinspector/categoryeditors/easing/easecurveeditor.xaml", UriKind.Relative));
    }
