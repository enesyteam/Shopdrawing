...
namespace Microsoft.Expression.DesignSurface.UserInterface.PropertyInspector
{
  public class SceneNodeProperty : PropertyReferenceProperty
  {
    ...
    private DependencyPropertyValueSource valueSource = DependencyPropertyValueSource.get_LocalValue();
    ...
    public bool IsExpression
    {
      get
      {
        return this.valueSource.get_IsMarkupExtension();
      }
    }
    ...
    public bool IsResource
    {
      get
      {
        if (!this.valueSource.get_IsResource())
          return this.valueSource.get_IsStatic();
        return true;
      }
    }
    ...
    private bool IsEditingUriOnMediaElementWithOwningTimeline
    {
      get
      {
        if (typeof (Uri).IsAssignableFrom(base.get_PropertyType()) && typeof (MediaElement).IsAssignableFrom(this.SceneNodeObjectSet.ObjectType))
        {
    ...
    private bool IsRuntimeNameProperty
    {
      get
      {
        ...
        if (propertyId != null)
          return propertyId.Name == base.get_PropertyName();
        return false;
      }
    }
    ...
    public bool IsValueDataBound
    {
      get
      {
        return this.valueSource.get_IsBinding();
      }
    }
    ...
    public bool IsValueLocalResource
    {
      get
      {
        return this.valueSource.get_IsResource();
      }
    }
    ...
    public bool IsValueTemplateBinding
    {
      get
      {
        return this.valueSource.get_IsTemplateBinding();
      }
    }
    ...
    public bool IsValueCustomMarkupExtension
    {
      get
      {
        return this.valueSource.get_IsCustomMarkupExtension();
      }
    }
    ...
    public bool IsValueLocal
    {
      get
      {
        return this.valueSource.get_IsLocalValue();
      }
    }
    ...
    public bool IsValueDefaultValue
    {
      get
      {
        return this.valueSource.get_IsDefaultValue();
      }
    }
    ...
    public bool IsValueInherited
    {
      get
      {
        return this.valueSource.get_IsInheritedValue();
      }
    }
    ...
    public object ToolTip
    {
      get
      {
        ...
        return (object) new DocumentationEntry(this.Reference.TargetType.Name, base.get_DisplayName(), PlatformTypeHelper.GetPropertyType((IProperty) this.Reference.LastStep), result);
      }
    }
    ...
    public ReadOnlyObservableCollection<ResourceVirtualizingTreeItem> VirtualizingResources
    {
      get
      {
        ...
        if (this.IsEnabledLocalResource)
        {
          ...
          {
            (object) base.get_PropertyType().Name
          }));
    ...
    public IEnumerable<SelectablePropertyModel<SystemResourceModel>> SystemResources
    {
      get
      {
        ...
        if (this.ValueSource.get_IsStatic())
        {
          bool isMixed;
    ...
    public IEnumerable<SelectablePropertyModel<TemplateBindablePropertyModel>> TemplateBindableProperties
    {
      get
      {
        ...
        if (this.ValueSource.get_IsTemplateBinding())
        {
          bool isMixed;
        ...
        Type propertyType = base.get_PropertyType();
    ...
    private bool IsValueLegal(object value, out string errorMessage)
    {
      ...
      if (DictionaryEntryNode.ValueProperty.Equals(this.Reference.LastStep) && value == null)
      {
    ...
    {
      if (valueSourceThatChanged.get_IsBinding())
        this.OnPropertyChanged("IsValueDataBound");
      else if (valueSourceThatChanged.get_IsStatic())
      {
        this.OnPropertyChanged("SystemResources");
        this.OnPropertyChanged("VirtualizingResources");
        this.OnPropertyChanged("IsValueSystemResource");
      }
      else if (valueSourceThatChanged.get_IsResource())
      {
        this.OnPropertyChanged("LocalResources");
        this.OnPropertyChanged("VirtualizingResources");
        this.OnPropertyChanged("IsValueLocalResource");
      }
      else if (valueSourceThatChanged.get_IsTemplateBinding())
        this.OnPropertyChanged("IsValueTemplateBinding");
      else if (valueSourceThatChanged.get_IsCustomMarkupExtension())
        this.OnPropertyChanged("IsValueCustomMarkupExtension");
      else if (valueSourceThatChanged.get_IsLocalValue())
        this.OnPropertyChanged("IsValueLocal");
      else if (valueSourceThatChanged.get_IsDefaultValue())
      {
        this.OnPropertyChanged("IsValueDefaultValue");
      }
      else
      {
        if (!valueSourceThatChanged.get_IsInheritedValue())
          return;
    ...
    public override void Recache()
    {
      ...
      {
        if (this.Inherits)
          this.ValueSource = DependencyPropertyValueSource.get_InheritedValue();
        else
          this.ValueSource = DependencyPropertyValueSource.get_DefaultValue();
      }
      else if (DocumentNodeUtilities.IsBinding(valueAsDocumentNode))
        this.ValueSource = DependencyPropertyValueSource.get_Binding();
      else if (DocumentNodeUtilities.IsTemplateBinding(valueAsDocumentNode))
        this.ValueSource = DependencyPropertyValueSource.get_TemplateBinding();
      else if (DocumentNodeUtilities.IsStaticExtension(valueAsDocumentNode))
        this.ValueSource = DependencyPropertyValueSource.get_LocalValue();
      else if (DocumentNodeUtilities.IsDynamicResource(valueAsDocumentNode) || DocumentNodeUtilities.IsStaticResource(valueAsDocumentNode))
      {
        ...
        {
          this.ValueSource = DependencyPropertyValueSource.get_Static();
          this.OnPropertyChanged("SelectedSystemResourceModel");
        }
        else
        {
          this.ValueSource = DocumentNodeUtilities.IsDynamicResource(valueAsDocumentNode) ? DependencyPropertyValueSource.get_DynamicResource() : DependencyPropertyValueSource.get_StaticResource();
          this.OnPropertyChanged("SelectedLocalResourceModel");
        }
        this.OnPropertyChanged("VirtualizingResources");
      }
      else if (DocumentNodeUtilities.IsMarkupExtension(valueAsDocumentNode))
        this.ValueSource = DependencyPropertyValueSource.get_CustomMarkupExtension();
      else
        this.ValueSource = DependencyPropertyValueSource.get_LocalValue();
    }
    ...
    {
      return this.SceneNodeObjectSet.GetLocalValueAsDocumentNode(this, (GetLocalValueFlags) ((resolved ? 1 : 0) | 4), out isMixed);
    }
    ...
    public override void OnRemoveFromCategory()
    {
      if (this.Reference != null)
      {
        ...
        this.SceneNodeObjectSet.PropertyChanged -= new PropertyChangedEventHandler(this.SceneNodeProperty_PropertyTargetPropertyChanged);
        ((PropertyReferencePropertyValue) this.get_PropertyValue()).Unhook();
      }
    ...
    public bool SetExpressionAsString(string text)
    {
      if (text.Length > 0 && (int) text[0] == 123)
      {
        ...
        else
        {
          ...
          DocumentNode expressionFromString = XamlExpressionSerializer.GetExpressionFromString(text, representativeNode, base.get_PropertyType(), out errors);
      ...
      this.get_PropertyValue().add_PropertyValueException(new EventHandler<PropertyValueExceptionEventArgs>(this.OnPropertyValueException));
      this.get_PropertyValue().set_StringValue(text);
      this.get_PropertyValue().remove_PropertyValueException(new EventHandler<PropertyValueExceptionEventArgs>(this.OnPropertyValueException));
    ...
    public void DoEditCustomExpression(FrameworkElement target)
    {
      ...
      if (this.IsExpression)
      {
        ...
        if (!isMixed)
          this.expressionAsString = this.ConvertExpressionToString(valueAsDocumentNode);
      }
    ...
    private void OnPropertyValueException(object sender, PropertyValueExceptionEventArgs e)
    {
      ...
      {
        (object) e.get_Exception().Message
      });
    }
    ...
    private string ConvertExpressionToString(object expressionObject)
    {
      ...
      else
      {
        ...
        try
        {
          str1 = this.get_PropertyValue().get_StringValue();
        }
        catch
        {
        }
    ...
    private bool MakeNewResource(DocumentNode resourceNode, Type resourceType, Type targetType, IPropertyId targetTypeProperty)
    {
      SceneViewModel viewModel = this.ViewModel;
      SceneNode representativeSceneNode = this.SceneNodeObjectSet.RepresentativeSceneNode;
      CreateResourceModel model = new CreateResourceModel(viewModel, this.SceneNodeObjectSet.DesignerContext.ResourceManager, resourceType, targetType, base.get_PropertyName(), (SceneElement) null, representativeSceneNode, CreateResourceModel.ContextFlags.None);
    ...
    {
      bool flag1 = !object.Equals(this.Reference, (object) propertyReference);
