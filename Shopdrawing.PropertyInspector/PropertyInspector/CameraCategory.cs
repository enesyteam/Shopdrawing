...
//      set
//      {
//        this.upDirectionProperty.SetValue(this.CameraUpVectorFromSpinnerRotationAngle(value));
...
//          if (current.get_PropertyName() == "UpDirection")
//            this.upDirectionProperty = current as PropertyReferenceProperty;
//          else if (current.get_PropertyName() == "LookDirection")
//            this.lookDirectionProperty = current as PropertyReferenceProperty;
//        }
//      }
//      if (this.upDirectionProperty != null)
//        this.upDirectionProperty.PropertyReferenceChanged += new Microsoft.Expression.DesignSurface.Documents.PropertyReferenceChangedEventHandler(this.OnRotationAngleChanged);
