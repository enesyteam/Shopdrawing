...
namespace DynamicGeometry
{
    ...
    {
        // Cá Cơm
        public static bool ChangeLineAppearanceWhenMouseHover = true;
        public static bool ShowCoordinationsWhenMouseHover = true;
        public static int GridLabelStep = 5;
        public static int GridStep = 5;
        ...
        public static double DefaultUnitLength = 1;
        public static double DefaultToolbarFontSize = 11;
        public static Color PropertyGridTitleColor = Colors.Black;
        ...
        public static bool ScaleTextWithDrawing = true;
        public static double CurrentDrawingVersion = 11;
