...
namespace DynamicGeometry
{
        ...
        INotifyPropertyChanging
    {
        ...
        // Cá cơm
        private bool mIsMouseHover = false;
        [Browsable(false)]
        public virtual bool IsMouseHover
        {
            get
            {
                return mIsMouseHover;
            }
            set
            {
                mIsMouseHover = value;
        ...
        //CC
        [Browsable(false)]
        public virtual bool IsMouseHoverVisible { get; set; }
        //
        ...
        // CC
        public abstract IFigure MouseHover(Point point);
