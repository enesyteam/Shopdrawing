...
namespace DynamicGeometry
{
    public abstract partial class Behavior : INotifyPropertyChanged
    {
        ...
        public virtual Canvas ParentCanvas
        {
            ...
            set
            {
                if (mParentCanvas != null)
                {
                    ...
                    mParentCanvas.MouseDown -= SafeMouseDown;
                    mParentCanvas.MouseMove -= SafeMouseMove;
                    mParentCanvas.MouseUp -= SafeMouseUp;
        ...
        // CC
        public virtual void MouseHover(object sender, MouseEventArgs e)
        { 
        }
        ...
        public virtual void MouseWheel(object sender, MouseWheelEventArgs e)
        {
            if (Drawing != null)
            {
                if (e.Delta > 0)
                {
                    Drawing.CoordinateSystem.ZoomIn(e.GetPosition(Drawing.Canvas));
                    //Drawing.CoordinateSystem.ZoomIn();
                }
                else if (e.Delta < 0)
                {
                    Drawing.CoordinateSystem.ZoomOut(e.GetPosition(Drawing.Canvas));
