...
namespace Microsoft.Expression.Framework.UserInterface
{
  public sealed class AboutDialog : Dialog
  {
    ...
    public Version Version
    {
      ...
      {
        this.version = value;
        ((TextBlock) LogicalTreeHelper.FindLogicalNode((DependencyObject) this, "Title")).Text = string.Format((IFormatProvider) CultureInfo.CurrentCulture, this.FindResource("ApplicationVersionTitle") as string, new object[1]
        {
    ...
    public AboutDialog(IServices services, string pid)
    {
      ...
      //  this.Resources.MergedDictionaries.Add(aboutDialogResources);
        this.Title = "dddd"; // this.Resources[(object) "AboutDialogTitle"] as string;
      ...
      if (!string.IsNullOrEmpty(pid))
          ...
          textBlock1.Text = "BridgeFS"; // service.MostPermissivePid;
      textBlock2.Text = "Shopdrawing 2015"; // this.GetLicensingStatusText(service);
