...
namespace Microsoft.VisualStudio.PlatformUI.Shell.Controls
{
  public class DockGroupControl : SplitterItemsControl
  {
    ...
    {
      FrameworkElement.DefaultStyleKeyProperty.OverrideMetadata(typeof (DockGroupControl), (PropertyMetadata) new FrameworkPropertyMetadata(typeof (DockGroupControl)));
    }
