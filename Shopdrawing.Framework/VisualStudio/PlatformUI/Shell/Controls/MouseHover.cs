...
namespace Microsoft.VisualStudio.PlatformUI.Shell.Controls
{
    public static class MouseHover
    {
        ...
        static MouseHover()
        {
            ...
            MouseHover.MouseHoverDelayProperty = DependencyProperty.RegisterAttached("MouseHoverDelay", typeof(TimeSpan), typeof(MouseHover), new FrameworkPropertyMetadata(TimeSpan.Zero));
