...
// Type: Microsoft.Expression.DesignSurface.Tools.SpotLightProxyAdornerSet3D
...
{
  internal class SpotLightProxyAdornerSet3D : AdornerSet3D
  {
    ...
    {
      this.adorner = (Adorner3D) new SpotLightProxy3D((AdornerSet3D) this);
