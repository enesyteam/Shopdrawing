...
// Type: Microsoft.Expression.DesignSurface.Tools.Transforms.ScaleAdornerSetCreator
...
{
  internal sealed class ScaleAdornerSetCreator : IMultipleElementAdornerSetCreator, IAdornerSetCreator
  {
    ...
    {
      return (IAdornerSet) new ScaleAdornerSet(toolContext, (BaseFrameworkElement) adornedElement);
    }
  }
}
