...
// Type: Microsoft.Expression.DesignSurface.Tools.Transforms.ScaleAdornerSet
...
{
  internal class ScaleAdornerSet : AdornerSet
  {
    public override ToolBehavior Behavior
    {
      get
      {
        return (ToolBehavior) new ScaleBehavior(this.ToolContext);
      }
    }

    public ScaleAdornerSet(ToolBehaviorContext toolContext, BaseFrameworkElement adornedElement)
      : base(toolContext, (SceneElement) adornedElement, AdornerSetOrderTokens.TopPriority)
    {
    }
