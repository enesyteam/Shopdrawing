...
// Type: Microsoft.Expression.DesignSurface.Tools.Transforms.MultipleElementSizeAdornerSet
...
{
  internal class MultipleElementSizeAdornerSet : AdornerSet
  {
    public override ToolBehavior Behavior
    {
      get
      {
        return (ToolBehavior) new MultipleElementSizeBehavior(this.ToolContext);
      }
    }

    public MultipleElementSizeAdornerSet(ToolBehaviorContext toolContext, AdornerElementSet adornedElement)
