...
// Type: Microsoft.Expression.DesignSurface.Tools.Path.ConvertPointAction
...
{
  internal class ConvertPointAction : RedefineTangentAction
  {
    public override Cursor HoverCursor
    {
      get
      {
        return ToolCursors.ConvertPointCursor;
      }
    }
