...
// Type: Microsoft.Expression.DesignSurface.ViewModel.SceneNodeSearch.BooleanOrPredicate
...
{
  public class BooleanOrPredicate : ISearchPredicate
  {
    ...
    public BooleanOrPredicate(ISearchPredicate lhs, ISearchPredicate rhs)
    {
      this.lhs = lhs;
      this.rhs = rhs;
    }
