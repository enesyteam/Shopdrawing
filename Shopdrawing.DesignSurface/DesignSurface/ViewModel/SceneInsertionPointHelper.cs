...
// Type: Microsoft.Expression.DesignSurface.ViewModel.SceneInsertionPointHelper
...
{
  public sealed class SceneInsertionPointHelper
  {
    private SceneInsertionPointHelper()
    {
    }
