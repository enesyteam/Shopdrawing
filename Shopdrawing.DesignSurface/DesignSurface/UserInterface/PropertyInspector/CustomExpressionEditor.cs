...
namespace Microsoft.Expression.DesignSurface.UserInterface.PropertyInspector
{
  ...
  public sealed class CustomExpressionEditor : WorkaroundPopup, INotifyPropertyChanged, IComponentConnector
  {
    ...
    public string EditingExpression
    {
      ...
      set
      {
        ...
        if (this.PropertyChanged == null)
          return;
        this.PropertyChanged((object) this, new PropertyChangedEventArgs("EditingExpression"));
      }
    }
    ...
    public void InitializeComponent()
    {
      ...
      Application.LoadComponent((object) this, new Uri("/Microsoft.Expression.DesignSurface;component/userinterface/propertyinspector/customexpressioneditor.xaml", UriKind.Relative));
    }
