...
namespace Microsoft.Expression.DesignSurface.UserInterface.PropertyInspector
{
  public class PropertyReferenceProperty : PropertyBase
  {
    ...
    public PropertyOrderWrapper PropertyOrder
    {
      get
      {
        Microsoft.Windows.Design.PropertyEditing.PropertyOrder propertyOrder = Microsoft.Windows.Design.PropertyEditing.PropertyOrder.Default;
        if (this.attributes != null)
        {
          ...
          if (propertyOrderAttribute != null)
            propertyOrder = propertyOrderAttribute.Order;
        }
    ...
    public override PropertyIdentifier Identifier
    {
      get
      {
        return new PropertyIdentifier(this.ObjectSet.ObjectType, this.PropertyName);
      }
    }
    ...
    public Type ProxyPropertyType
    {
      get
      {
        if (this.proxyType != (Type) null && !this.PropertyValue.IsMixedValue)
      ...
      : base(parentValue)
    {
      ...
      this.InitializeConverter(this.PropertyName);
    ...
    {
      if ((propertyName == "Content" || propertyName == "Header" || (propertyName == "ToolTip" || propertyName == "Tag") || propertyName == "ToolTipService.ToolTip") && this.PropertyType.IsAssignableFrom(typeof (object)))
      {
      ...
      {
        if (this.attributes != null)
          this.converter = Microsoft.Expression.DesignModel.Metadata.MetadataStore.GetTypeConverterFromAttributes(this.PropertyType != (Type) null ? this.PropertyType.Assembly : (Assembly) null, this.attributes);
    ...
    {
      bool flag1 = !object.Equals((object) this.propertyReference, (object) propertyReference);
    ...
    {
      this.ModifyValue((object) null, PropertyReferenceProperty.Modification.ClearValue, -1);
    }
    ...
    {
      this.ModifyValue((object) null, PropertyReferenceProperty.Modification.RemoveValue, index);
    }
    ...
    protected virtual void OnPropertyReferenceChanged(PropertyReferenceChangedEventArgs e)
    {
      if (this.PropertyReferenceChanged == null)
        return;
      this.PropertyReferenceChanged((object) this, e);
    }
