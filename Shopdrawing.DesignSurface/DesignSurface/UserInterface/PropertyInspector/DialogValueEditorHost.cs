...
namespace Microsoft.Expression.DesignSurface.UserInterface.PropertyInspector
{
  ...
  {
    public DialogValueEditorHost(Microsoft.Windows.Design.PropertyEditing.PropertyValue propertyValue, DataTemplate dialogContent)
    {
      ...
      contentControl.Content = (object) propertyValue;
