...
namespace Microsoft.Expression.DesignSurface.UserInterface.PropertyInspector
{
  public class EasingFunctionSelectionButton : Button
  {
    ...
    public static readonly DependencyProperty SelectedEasingFunctionProperty = DependencyProperty.Register("SelectedEasingFunction", typeof (IEasingFunctionDefinition), typeof (EasingFunctionSelectionButton), (PropertyMetadata) new FrameworkPropertyMetadata((object) null, new PropertyChangedCallback(EasingFunctionSelectionButton.OnSelectedEasingFunctionChanged)));
    public static readonly DependencyProperty OwnEasingFunctionProperty = DependencyProperty.Register("OwnEasingFunction", typeof (IEasingFunctionDefinition), typeof (EasingFunctionSelectionButton), (PropertyMetadata) new FrameworkPropertyMetadata((object) null, FrameworkPropertyMetadataOptions.AffectsRender));
    ...
    public EasingMode Easing
    {
      ...
      set
      {
        this.SetValue(EasingFunctionSelectionButton.EasingProperty, (object) value);
      }
    }
    ...
    public IEasingFunctionDefinition SelectedEasingFunction
    {
      ...
      set
      {
        this.SetValue(EasingFunctionSelectionButton.SelectedEasingFunctionProperty, (object) value);
      }
    }
    ...
    public IEasingFunctionDefinition OwnEasingFunction
    {
      ...
      set
      {
        this.SetValue(EasingFunctionSelectionButton.OwnEasingFunctionProperty, (object) value);
      }
    }
    ...
    public bool CanBeEnabled
    {
      ...
      set
      {
        this.SetValue(EasingFunctionSelectionButton.CanBeEnabledProperty, (object) (bool) (value ? true : false));
      }
    }
    ...
    public bool MatchesSelection
    {
      ...
      set
      {
        this.SetValue(EasingFunctionSelectionButton.MatchesSelectionProperty, (object) (bool) (value ? true : false));
      }
    }
    ...
    public bool IsHighlighted
    {
      ...
      set
      {
        this.SetValue(EasingFunctionSelectionButton.IsHighlightedProperty, (object) (bool) (value ? true : false));
      }
    }
    ...
    public void FireButtonPressed()
    {
      if (this.OnButtonPressed == null)
        return;
      this.OnButtonPressed((object) this, new RoutedEventArgs());
    }
