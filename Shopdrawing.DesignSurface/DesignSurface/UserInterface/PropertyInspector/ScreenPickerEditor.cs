  ...
  public abstract class ScreenPickerEditor : Grid, INotifyPropertyChanged, IComponentConnector
  {
    ...
    public string CurrentScreen
    {
      get
      {
        if (this.EditingProperty == null || this.EditingProperty.PropertyValue == null)
          return (string) null;
        IPrototypingScreen prototypingScreen = !string.IsNullOrEmpty((string) this.EditingProperty.PropertyValue.Value) ? this.FindScreenByName(this.EditingProperty.PropertyValue.Value as string) : this.DefaultValue;
      ...
      set
      {
        ...
        if (screenByName == null || screenByName == this.DefaultValue)
          ...
          this.EditingProperty.PropertyValue.Value = (object) screenByName.ClassName;
      }
    }
    ...
    private SceneNodeProperty EditingProperty
    {
      ...
      set
      {
        ...
        this.EditingProperty.PropertyReferenceChanged += new Microsoft.Expression.DesignSurface.Documents.PropertyReferenceChangedEventHandler(this.ScreenNameProperty_PropertyReferenceChanged);
        this.CurrentScreenInfo = this.FindScreenByName(this.editingProperty.PropertyValue.Value as string);
      }
    }
    ...
    private void Rebuild()
    {
      ...
      this.CurrentScreenInfo = this.FindScreenByName(this.editingProperty.PropertyValue.Value as string);
      this.ScreensView = CollectionViewSource.GetDefaultView((object) this.screens);
    ...
    public void InitializeComponent()
    {
      ...
      Application.LoadComponent((object) this, new Uri("/Microsoft.Expression.DesignSurface;component/userinterface/propertyinspector/complexvalueeditors/screenpickereditor.xaml", UriKind.Relative));
    }
