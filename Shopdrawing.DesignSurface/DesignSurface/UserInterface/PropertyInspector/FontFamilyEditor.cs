...
namespace Microsoft.Expression.DesignSurface.UserInterface.PropertyInspector
{
  ...
  public sealed class FontFamilyEditor : Decorator, IComponentConnector
  {
    ...
    public List<SourcedFontFamilyItem> FontFamilies
    {
      ...
      set
      {
        this.SetValue(FontFamilyEditor.FontFamiliesProperty, (object) value);
      }
    }
    ...
    public SourcedFontFamilyItem CurrentFontItem
    {
      ...
      set
      {
        this.SetValue(FontFamilyEditor.CurrentFontItemProperty, (object) value);
      }
    }
    ...
    public PropertyContainer OwningPropertyContainer
    {
      ...
      set
      {
        this.SetValue(FontFamilyEditor.OwningPropertyContainerProperty, (object) value);
      }
    }
    ...
    public FontFamilyEditor()
    {
      ...
      this.SetBinding(FontFamilyEditor.CurrentFontItemProperty, (BindingBase) new MultiBinding()
      {
        ...
        Bindings = {
          ...
          {
            Source = (object) this.FontChoiceEditor,
    ...
    private static void owningPropertyContainerChanged(object sender, DependencyPropertyChangedEventArgs e)
    {
      ...
      if (propertyContainer == null)
        return;
      propertyContainer.SetValue(FontFamilyEditor.FontFamilyEditorProperty, sender);
    }
    ...
    public void InitializeComponent()
    {
      ...
      Application.LoadComponent((object) this, new Uri("/Microsoft.Expression.DesignSurface;component/userinterface/propertyinspector/complexvalueeditors/fontfamilyeditor.xaml", UriKind.Relative));
    }
