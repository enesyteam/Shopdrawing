...
namespace Microsoft.Expression.DesignSurface.UserInterface.PropertyInspector
{
  public class TriggerCategory : SceneNodeCategory
  {
    ...
    public override CategoryHelpContext CategoryHelpContext
    {
      get
      {
        return new CategoryHelpContext((object) this.TriggerType, string.Format((IFormatProvider) CultureInfo.CurrentCulture, StringTable.DefaultCategoryHelpToolTipFormat, new object[1]
        {
          (object) this.TriggerType.Name
        }));
      }
    ...
    public override void ApplyFilter(PropertyFilter filter)
    {
      ...
      int num1 = triggerCategory1.BasicPropertyMatchesFilter | this.MatchesFilter ? true : false;
      triggerCategory1.BasicPropertyMatchesFilter = num1 != 0;
      TriggerCategory triggerCategory2 = this;
      int num2 = triggerCategory2.AdvancedPropertyMatchesFilter | this.MatchesFilter ? true : false;
