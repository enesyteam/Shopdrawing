...
namespace Microsoft.Expression.DesignSurface.UserInterface.PropertyInspector
{
  public class EasingFunctionPreviewIcon : Icon
  {
    ...
    public static readonly DependencyProperty EasingFunctionProperty = DependencyProperty.Register("EasingFunction", typeof (IEasingFunctionDefinition), typeof (EasingFunctionPreviewIcon), (PropertyMetadata) new FrameworkPropertyMetadata((object) null, FrameworkPropertyMetadataOptions.AffectsRender));
    ...
    public IEasingFunctionDefinition EasingFunction
    {
      ...
      set
      {
        this.SetValue(EasingFunctionPreviewIcon.EasingFunctionProperty, (object) value);
      }
    }
    ...
    public EasingMode Easing
    {
      ...
      set
      {
        this.SetValue(EasingFunctionPreviewIcon.EasingProperty, (object) value);
      }
    }
    ...
    public Brush Brush
    {
      ...
      set
      {
        this.SetValue(EasingFunctionPreviewIcon.BrushProperty, (object) value);
      }
    }
