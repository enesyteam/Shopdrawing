  ...
  public sealed class GradientBrushEditorControl : Grid, IComponentConnector
  {
    ...
    public ICommand BeginGradientEyedropperCommand
    {
      get
      {
        ...
        {
          ValueEditorUtils.ExecuteCommand((ICommand) PropertyValueEditorCommands.BeginTransaction, (IInputElement) this, (object) null);
    ...
    public ICommand CancelGradientEyedropperCommand
    {
      get
      {
        return (ICommand) new ArgumentDelegateCommand((ArgumentDelegateCommand.ArgumentEventHandler) (parameter =>
        {
          ...
          ValueEditorUtils.ExecuteCommand((ICommand) PropertyValueEditorCommands.AbortTransaction, (IInputElement) this, (object) null);
        }));
      }
    }
    ...
    public ICommand CommitGradientEyedropperCommand
    {
      get
      {
        ...
        {
          this.RestoreDataContext();
          ValueEditorUtils.ExecuteCommand((ICommand) PropertyValueEditorCommands.CommitTransaction, (IInputElement) this, (object) null);
        }));
      }
    }
