...
namespace Microsoft.Expression.DesignSurface.UserInterface.PropertyInspector.TransformEditor
{
  public sealed class ArcBallPresenter : Control
  {
    ...
    private System.Windows.Media.Geometry XYFrontGeometry;
    private System.Windows.Media.Geometry XZFrontGeometry;
    private System.Windows.Media.Geometry YZFrontGeometry;
    private System.Windows.Media.Geometry XYBackGeometry;
    private System.Windows.Media.Geometry YZBackGeometry;
    private System.Windows.Media.Geometry XZBackGeometry;
    ...
    private void UpdateGeometries(Quaternion orientation)
    {
      ...
      this.XYFrontGeometry = (System.Windows.Media.Geometry)frontGeometry;
      this.XYBackGeometry = (System.Windows.Media.Geometry)backGeometry;
      this.GetArcGeometry(vector3D1, vector3D3, -vector3D2, out frontGeometry, out backGeometry);
      this.XZFrontGeometry = (System.Windows.Media.Geometry)frontGeometry;
      this.XZBackGeometry = (System.Windows.Media.Geometry)backGeometry;
      this.GetArcGeometry(vector3D2, vector3D3, vector3D1, out frontGeometry, out backGeometry);
      this.YZFrontGeometry = (System.Windows.Media.Geometry)frontGeometry;
      this.YZBackGeometry = (System.Windows.Media.Geometry)backGeometry;
    }
