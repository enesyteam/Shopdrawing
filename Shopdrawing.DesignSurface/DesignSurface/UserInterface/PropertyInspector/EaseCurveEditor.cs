...
namespace Microsoft.Expression.DesignSurface.UserInterface.PropertyInspector
{
  ...
  public sealed class EaseCurveEditor : Control, IComponentConnector
  {
    ...
    public bool X1IsNinched
    {
      ...
      set
      {
        this.SetValue(EaseCurveEditor.X1IsNinchedProperty, (object) (bool) (value ? true : false));
      }
    }
    ...
    public bool Y1IsNinched
    {
      ...
      set
      {
        this.SetValue(EaseCurveEditor.Y1IsNinchedProperty, (object) (bool) (value ? true : false));
      }
    }
    ...
    public bool X2IsNinched
    {
      ...
      set
      {
        this.SetValue(EaseCurveEditor.X2IsNinchedProperty, (object) (bool) (value ? true : false));
      }
    }
    ...
    public bool Y2IsNinched
    {
      ...
      set
      {
        this.SetValue(EaseCurveEditor.Y2IsNinchedProperty, (object) (bool) (value ? true : false));
      }
    }
    ...
    protected override void OnRender(DrawingContext drawingContext)
    {
      ...
      if (!this.X1IsNinched && !this.Y1IsNinched && (!this.X2IsNinched && !this.Y2IsNinched))
          drawingContext.DrawGeometry((Brush)null, this.curvePen, (System.Windows.Media.Geometry)this.pathGeometry);
