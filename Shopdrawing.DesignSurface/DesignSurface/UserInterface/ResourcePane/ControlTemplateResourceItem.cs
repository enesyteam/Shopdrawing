...
// Type: Microsoft.Expression.DesignSurface.UserInterface.ResourcePane.ControlTemplateResourceItem
...
{
  public class ControlTemplateResourceItem : TypedResourceItem
  {
    public override IType EffectiveTypeId
    {
      get
      {
        return this.DocumentNode.TypeResolver.ResolveType(PlatformTypes.ControlTemplate);
      }
    }
    ...
    protected override IPropertyId TargetTypeProperty
    {
      get
      {
        return ControlTemplateElement.TargetTypeProperty;
      }
    }
