...
// Type: Microsoft.Expression.DesignSurface.UserInterface.ResourcePane.BrushResourceItem
...
{
  public class BrushResourceItem : ResourceEntryItem
  {
    public override IType EffectiveTypeId
    {
      get
      {
        return this.DocumentNode.TypeResolver.ResolveType(PlatformTypes.Brush);
      }
    }
