...
// Type: Microsoft.Expression.DesignSurface.UserInterface.ResourcePane.DataTemplateResourceItem
...
{
  public class DataTemplateResourceItem : TypedResourceItem
  {
    public override IType EffectiveTypeId
    {
      get
      {
        return this.DocumentNode.TypeResolver.ResolveType(PlatformTypes.DataTemplate);
      }
    }
    ...
    protected override IPropertyId TargetTypeProperty
    {
      get
      {
        return DataTemplateElement.DataTypeProperty;
      }
    }
    ...
    public DataTemplateResourceItem(ResourceManager resourceManager, ResourceContainer resourceContainer, ResourceModel resource)
