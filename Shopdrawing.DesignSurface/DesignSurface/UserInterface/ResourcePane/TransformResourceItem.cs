...
// Type: Microsoft.Expression.DesignSurface.UserInterface.ResourcePane.TransformResourceItem
...
{
  public class TransformResourceItem : ResourceEntryItem
  {
    public override IType EffectiveTypeId
    {
      get
      {
        return this.DocumentNode.TypeResolver.ResolveType(PlatformTypes.Transform);
      }
    }
