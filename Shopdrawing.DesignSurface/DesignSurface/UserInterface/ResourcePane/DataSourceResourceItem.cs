...
// Type: Microsoft.Expression.DesignSurface.UserInterface.ResourcePane.DataSourceResourceItem
...
{
  public class DataSourceResourceItem : ResourceEntryItem
  {
    public override IType EffectiveTypeId
    {
      get
      {
        return this.DocumentNode.TypeResolver.ResolveType(PlatformTypes.XmlDataProvider);
      }
    }
