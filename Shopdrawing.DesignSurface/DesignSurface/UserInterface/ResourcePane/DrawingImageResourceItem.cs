...
// Type: Microsoft.Expression.DesignSurface.UserInterface.ResourcePane.DrawingImageResourceItem
...
{
  public class DrawingImageResourceItem : ResourceEntryItem
  {
    public override IType EffectiveTypeId
    {
      get
      {
        return this.DocumentNode.TypeResolver.ResolveType(PlatformTypes.DrawingImage);
      }
    }
