...
// Type: Microsoft.Expression.DesignSurface.SceneCommands.MakeSameSizeCommand
...
{
  internal class MakeSameSizeCommand : MakeSameSizeCommandBase
  {
    public override string UndoDescription
    {
      get
      {
        return StringTable.MakeSameSizeDescription;
      }
    }

    public MakeSameSizeCommand(SceneViewModel viewModel)
      : base(viewModel)
    {
    }
    ...
    public override void SetSize(Rect sourceRect, BaseFrameworkElement target, ILayoutDesigner targetLayoutDesigner)
    {
      ...
      targetLayoutDesigner.SetChildRect(target, childRect, true, true);
    }
  }
}
