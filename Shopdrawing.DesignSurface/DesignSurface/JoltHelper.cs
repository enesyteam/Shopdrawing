...
namespace Microsoft.Expression.DesignSurface
{
  internal static class JoltHelper
  {
    ...
    public static bool TypeHasEnumValues(IType typeId)
    {
      ...
      if (type == (Type) null)
        return false;
      if (!type.IsEnum && !PlatformTypes.Cursor.Equals((object) typeId) && (!PlatformTypes.FontWeight.Equals((object) typeId) && !PlatformTypes.FontStretch.Equals((object) typeId)) && !PlatformTypes.FontStyle.Equals((object) typeId))
