...
namespace Microsoft.VisualStudio.PlatformUI.Shell.Preferences
{
  ...
  {
    public static readonly DependencyProperty DocumentDockPreferenceProperty = DependencyProperty.Register("DocumentDockPreference", typeof (DockPreference), typeof (ViewManagerPreferences), new PropertyMetadata((object) DockPreference.DockAtBeginning));
    public static readonly DependencyProperty TabDockPreferenceProperty = DependencyProperty.Register("TabDockPreference", typeof (DockPreference), typeof (ViewManagerPreferences), new PropertyMetadata((object) DockPreference.DockAtBeginning));
    public static readonly DependencyProperty AllowDocumentTabAutoDockingProperty = DependencyProperty.Register("AllowDocumentTabAutoDocking", typeof (bool), typeof (ViewManagerPreferences), new PropertyMetadata((object) false));
    public static readonly DependencyProperty AllowTabGroupTabAutoDockingProperty = DependencyProperty.Register("AllowTabGroupTabAutoDocking", typeof (bool), typeof (ViewManagerPreferences), new PropertyMetadata((object) false));
    public static readonly DependencyProperty AutoHideHoverDelayProperty = DependencyProperty.Register("AutoHideHoverDelay", typeof (TimeSpan), typeof (ViewManagerPreferences), new PropertyMetadata((object) TimeSpan.FromMilliseconds(250.0)));
    public static readonly DependencyProperty AutoHideMouseExitGracePeriodProperty = DependencyProperty.Register("AutoHideMouseExitGracePeriod", typeof (TimeSpan), typeof (ViewManagerPreferences), new PropertyMetadata((object) TimeSpan.FromMilliseconds(500.0)));
    public static readonly DependencyProperty HideOnlyActiveViewProperty = DependencyProperty.Register("HideOnlyActiveView", typeof (bool), typeof (ViewManagerPreferences), new PropertyMetadata((object) true));
    public static readonly DependencyProperty AutoHideOnlyActiveViewProperty = DependencyProperty.Register("AutoHideOnlyActiveView", typeof (bool), typeof (ViewManagerPreferences), new PropertyMetadata((object) false));
    public static readonly DependencyProperty AlwaysHideAllViewInFloatingTabGroupProperty = DependencyProperty.Register("AlwaysHideAllViewInFloatingTabGroup", typeof (bool), typeof (ViewManagerPreferences), new PropertyMetadata((object) true));
