...
namespace Microsoft.VisualStudio.PlatformUI.Shell.Controls
{
  public class DocumentGroupControl : GroupControl
  {
    ...
    {
      FrameworkElement.DefaultStyleKeyProperty.OverrideMetadata(typeof (DocumentGroupControl), (PropertyMetadata) new FrameworkPropertyMetadata((object) typeof (DocumentGroupControl)));
    }
