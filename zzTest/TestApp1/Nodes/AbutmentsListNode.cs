...
{
    public class AbutmentsListNode : ShopdrawingTreeNode
    {
        public AbutmentsList AbutmentsList { get; set; }

        public AbutmentsListNode(AbutmentsList l)
        {
            AbutmentsList = l;
            DataObject = l;
        }

        string _text = "Abutments";
        ...
        public override bool CanDrop(DragEventArgs e, int index)
        {
            ...
            if (e.Data.GetDataPresent(AbutmentNode.DataFormat))
                return true;
        ...
        {
            string[] files = e.Data.GetData(AbutmentNode.DataFormat) as string[];
            if (files == null)
            {
