  ...
  internal class GradientBrushEditor : BrushSubtypeEditor
  {
    ...
    public Brush Brush
    {
      ...
      set
      {
        ...
        PropertyValueEditorCommands.BeginTransaction.Execute((object) null, (IInputElement) this.BrushEditor);
        ...
        PropertyValueEditorCommands.CommitTransaction.Execute((object) null, (IInputElement) this.BrushEditor);
        this.RebuildModel(-1);
      }
    }
    ...
    {
      foreach (PropertyEntry propertyEntry in (Collection<PropertyEntry>) this.AdvancedProperties)
      {
