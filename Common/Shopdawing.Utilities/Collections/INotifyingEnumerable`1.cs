...
// Type: Microsoft.Expression.Utility.Collections.INotifyingEnumerable`1
...
{
  public interface INotifyingEnumerable<T> : IEnumerable<T>, IEnumerable
  {
    event EventHandler<EnumerationChangedEventArgs<T>> EnumerationChanged;
  }
}
