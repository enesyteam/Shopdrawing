...
// Type: Microsoft.Expression.Utility.Events.WorkaroundEvents
...
{
  public static class WorkaroundEvents
  {
    public static readonly RoutedEvent PreviewGotKeyboardFocusEvent = EventManager.RegisterRoutedEvent("WorkaroundPreviewKeyboardFocus", RoutingStrategy.Bubble, typeof (RoutedEventHandler), typeof (UIElement));
  }
}
