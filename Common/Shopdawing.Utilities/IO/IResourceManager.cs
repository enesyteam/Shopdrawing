...
// Type: Microsoft.Expression.Utility.IO.IResourceManager
...
namespace Microsoft.Expression.Utility.IO
{
  ...
  {
    DocumentReference Source { get; }

    string GetStringResource(string identifier);

    ImageSource GetImageResource(string identifier, int preferredWidth, int preferredHeight);
  }
}
