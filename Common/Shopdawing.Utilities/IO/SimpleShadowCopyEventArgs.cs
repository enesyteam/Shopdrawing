...
// Type: Microsoft.Expression.Utility.IO.SimpleShadowCopyEventArgs
...
{
  [Serializable]
  public class SimpleShadowCopyEventArgs : EventArgs
  {
    public IEnumerable<SimpleShadowCopyResult> CopiedFiles { get; set; }
  }
}
