...
// Type: Microsoft.Expression.Utility.IO.ShadowCopyEventArgs
...
{
  [Serializable]
  public class ShadowCopyEventArgs : EventArgs
  {
    public IEnumerable<ShadowCopyResult> CopiedFiles { get; set; }
  }
}
