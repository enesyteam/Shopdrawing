...
// Type: Microsoft.Expression.Utility.InteractiveModeRequestEventArgs
...
{
  [Serializable]
  public class InteractiveModeRequestEventArgs : EventArgs
  {
    public InteractiveModeRequestType RequestType { get; set; }

    public InteractiveModeRequestEventArgs(InteractiveModeRequestType requestType)
    {
