...
// Type: Microsoft.Expression.Utility.ITypeNameFormatter
...
namespace Microsoft.Expression.Utility
{
  ...
  {
    string GenericArgumentListPrefix { get; }

    string GenericArgumentListSuffix { get; }

    string NamespaceDelimiter { get; }

    IEnumerable<string> TypePunctuators { get; }

    string GetTypePunctuator(string typeName, bool isValueType);
