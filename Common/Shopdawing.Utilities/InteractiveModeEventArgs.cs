...
// Type: Microsoft.Expression.Utility.InteractiveModeEventArgs
...
{
  public class InteractiveModeEventArgs : EventArgs
  {
    public InteractiveModeState CurrentState { get; private set; }

    public InteractiveModeEventArgs(InteractiveModeState currentState)
    {
