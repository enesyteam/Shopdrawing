...
namespace System.Windows.Controls.WpfPropertyGrid
{
  ...
  public partial class PropertyGrid : Control, INotifyPropertyChanged
  {
    ...
    public PropertyGrid()
    {
        Application.LoadComponent(this, new Uri("/System.Windows.Controls.WpfPropertyGrid;component/Design/PropertyGrid.xaml", UriKind.Relative));
      EventManager.RegisterClassHandler(typeof(PropertyGrid), GotFocusEvent, new RoutedEventHandler(ShowDescription), true);
      EventManager.RegisterClassHandler(typeof(PropertyGrid), GotFocusEvent, new RoutedEventHandler(ShowProperty), true);

      // Assign Layout to be Alphabetical by default
      //Layout = new CategorizedLayout(); // AlphabeticalLayout();
    ...
    private void ShowProperty(object sender, RoutedEventArgs e)
    {
        if (e.OriginalSource == null || !(e.OriginalSource is FrameworkElement) ||
            ...
            ((e.OriginalSource as FrameworkElement).DataContext as PropertyItemValue).ParentProperty == null)
            return;
        var pro = ((e.OriginalSource as FrameworkElement).DataContext as PropertyItemValue).ParentProperty.DisplayName;
        var pro2 = ((e.OriginalSource as FrameworkElement).DataContext as PropertyItemValue).ParentProperty.PropertyType;
        CurrentProperty = pro == null ? "" : pro.ToString();
        CurrentPropertyType = pro2 == null ? "" : pro2.Name;
    }
    /// <summary>
    /// Gets or sets the CurrentProperty property.  
    /// </summary>
    ...
    /// <summary>
    /// CurrentProperty Dependency Property
    /// </summary>
    public static readonly DependencyProperty CurrentPropertyTypeProperty =
        DependencyProperty.Register("CurrentPropertyType", typeof(string), typeof(PropertyGrid),
            new FrameworkPropertyMetadata((string)"",
                new PropertyChangedCallback(OnCurrentPropertyChanged)));
    /// <summary>
    /// CurrentProperty Dependency Property
    /// </summary>
    public static readonly DependencyProperty CurrentPropertyProperty =
        DependencyProperty.Register("CurrentProperty", typeof(string), typeof(PropertyGrid),
            new FrameworkPropertyMetadata((string)"",
                new PropertyChangedCallback(OnCurrentPropertyChanged)));
    /// <summary>
    /// Gets or sets the CurrentProperty property.  
    ...
    {
        get { return (string)GetValue(CurrentPropertyProperty); }
        set { SetValue(CurrentPropertyProperty, value); }
    }
    ...
    {
      ((PropertyGrid)d).OnCurrentPropertyChanged(e);
    }

    /// <summary>
    /// Provides derived classes an opportunity to handle changes to the CurrentDescription property.
    /// </summary>
    protected virtual void OnCurrentPropertyChanged(DependencyPropertyChangedEventArgs e)
    {
    }
    #endregion
