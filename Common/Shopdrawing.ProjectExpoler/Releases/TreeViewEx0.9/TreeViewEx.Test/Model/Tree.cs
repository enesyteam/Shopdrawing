...
namespace TreeViewEx.Test.Model
{
	class Tree
	{
        ...
        public Element Element2 { get { return element2 != null ? element2 : element2 = new Element(treeAutomationElement.FindDescendantByName(ControlType.TreeItem, "element2")); } }
	}
}
