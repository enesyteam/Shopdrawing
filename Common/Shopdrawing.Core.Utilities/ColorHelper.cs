...
namespace Shopdrawing.Core.Utilities
{
    ...
    public static class ColorHelper
    {
        ...
        /// <summary>
        /// Chuyển màu Color về AutoCAD color index
        /// http://www.isctex.com/acadcolors.php
        /// </summary>
        /// <param name="color"></param>
        /// <returns></returns>
        public static short ColorToAutoCADColor(System.Windows.Media.Color color)
        {
            string c = color.R.ToString() + "." + color.B.ToString() + "." + color.G.ToString(); //, color.B, color.G};
            switch(c)
            {
                case "0.0.0":
                    return 0; // Black
