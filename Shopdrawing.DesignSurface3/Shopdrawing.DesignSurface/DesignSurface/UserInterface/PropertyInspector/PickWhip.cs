...
namespace Microsoft.Expression.DesignSurface.UserInterface.PropertyInspector
{
  ...
  {
    public static readonly DependencyProperty ParentEditorProperty = DependencyProperty.Register("ParentEditor", typeof (FrameworkElement), typeof (PickWhip), new PropertyMetadata((object) null, new PropertyChangedCallback(PickWhip.ParentEditorChangedCallback)));
    ...
    public FrameworkElement ParentEditor
    {
      ...
      set
      {
        this.SetValue(PickWhip.ParentEditorProperty, (object) value);
      }
    }
