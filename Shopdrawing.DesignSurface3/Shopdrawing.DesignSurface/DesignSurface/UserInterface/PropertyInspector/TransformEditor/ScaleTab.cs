  ...
  public sealed class ScaleTab : Grid, ITransformEditorTab, IComponentConnector
  {
    ...
    public void UpdatePropertyContainers(TransformPropertyLookup propertyLookup)
    {
      ...
      if (propertyLookup.TransformType == TransformType.Transform3D)
      {
        ...
        {
          this.ScaleXEditor.PropertyEntry = (PropertyEntry) propertyLookup.CreateProperty("ScaleX", attributes);
          this.ScaleYEditor.PropertyEntry = (PropertyEntry) propertyLookup.CreateProperty("ScaleY", attributes);
          this.ScaleZEditor.PropertyEntry = (PropertyEntry) propertyLookup.CreateProperty("ScaleZ", attributes);
        }
        else
        {
          this.ScaleXEditor.PropertyEntry = (PropertyEntry) propertyLookup.CreateProperty("ScaleTransform/ScaleX", attributes);
          this.ScaleYEditor.PropertyEntry = (PropertyEntry) propertyLookup.CreateProperty("ScaleTransform/ScaleY", attributes);
          this.ScaleZEditor.PropertyEntry = (PropertyEntry) propertyLookup.CreateProperty("ScaleTransform/ScaleZ", attributes);
        }
      }
      else
      {
        ...
        this.ScaleZEditor.PropertyEntry = (PropertyEntry) null;
      }
    }
