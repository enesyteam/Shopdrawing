...
namespace Microsoft.Expression.DesignSurface.UserInterface.PropertyInspector
{
  ...
  public sealed class DataStorePropertyPickerEditor : Grid, INotifyPropertyChanged, IComponentConnector
  {
    ...
    public string PropertyNameEntry
    {
      ...
      set
      {
        this.SetValue(DataStorePropertyPickerEditor.PropertyNameEntryProperty, (object) value);
      }
    }
    ...
    private void OnDataContextChanged(object sender, DependencyPropertyChangedEventArgs e)
    {
      ...
      {
        this.parentProperty = nodePropertyValue.ParentProperty as SceneNodeProperty;
        this.parentProperty.PropertyReferenceChanged += new Microsoft.Expression.DesignSurface.Documents.PropertyReferenceChangedEventHandler(this.OnReferenceChanged);
      }
      this.Rebuild();
    }
    ...
    {
      this.Rebuild((object) this, EventArgs.Empty);
    }
    ...
    private void Rebuild()
    {
      ...
      this.dataStorePropertiesValueProvider.EditingProperty = this.dataStorePropertiesValueProvider.FindMatchDataStorePropertyEntry(nodePropertyValue.ParentProperty as SceneNodeProperty, propertyName);
      this.OnPropertyChanged("SelectedProperty");
    }
    ...
    public void InitializeComponent()
    {
      ...
      Application.LoadComponent((object) this, new Uri("/Microsoft.Expression.DesignSurface;component/userinterface/propertyinspector/complexvalueeditors/datastorepropertypickereditor.xaml", UriKind.Relative));
    }
