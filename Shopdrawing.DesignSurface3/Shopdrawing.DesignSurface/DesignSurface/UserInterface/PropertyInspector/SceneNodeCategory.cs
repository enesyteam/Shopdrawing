...
namespace Microsoft.Expression.DesignSurface.UserInterface.PropertyInspector
{
  public class SceneNodeCategory : CategoryBase
  {
    ...
    public virtual CategoryHelpContext CategoryHelpContext
    {
      get
      {
        return new CategoryHelpContext((object) this.CategoryName, string.Format((IFormatProvider) CultureInfo.CurrentCulture, StringTable.DefaultCategoryHelpToolTipFormat, new object[1]
        {
    ...
    private void InitializeIcons()
    {
      ...
      {
        SceneNodeCategoryEditor nodeCategoryEditor = categoryEditor as SceneNodeCategoryEditor;
    ...
    public override void ApplyFilter(PropertyFilter filter)
    {
      ...
      foreach (PropertyEntry property in this.attachedPropertyEntries)
      {
        if (property.IsAdvanced)
    ...
    {
      dependencyObject.SetValue(SceneNodeCategory.AttachedPropertyEntryProperty, (object) value);
    }
    ...
    private class CategoryOrder : IComparable
    {
      ...
      public int CompareTo(object rhs)
      {
        ...
        if (num != 0)
          return num;
        return this.category.CategoryName.CompareTo(categoryOrder.category.CategoryName);
      }
    }

    private class PropertyComparer : Comparer<PropertyEntry>
    {
