...
namespace Microsoft.Expression.DesignSurface.UserInterface.PropertyInspector
{
  ...
  {
    public static readonly DependencyProperty PropertyValueProperty = DependencyProperty.Register("PropertyValue", typeof (Microsoft.Windows.Design.PropertyEditing.PropertyValue), typeof (FontConverter));

    public Microsoft.Windows.Design.PropertyEditing.PropertyValue PropertyValue
    {
      get
      {
        return (Microsoft.Windows.Design.PropertyEditing.PropertyValue) this.GetValue(FontConverter.PropertyValueProperty);
      }
      set
      {
        this.SetValue(FontConverter.PropertyValueProperty, (object) value);
      }
    }
    ...
    private SceneViewModel ViewModel
    {
      get
      {
        return ((SceneNodeProperty) this.PropertyValue.ParentProperty).SceneNodeObjectSet.ViewModel;
      }
    }
    ...
    private SceneNodeObjectSet SceneNodeObjectSet
    {
      get
      {
        return ((SceneNodeProperty) this.PropertyValue.ParentProperty).SceneNodeObjectSet;
      }
    }
