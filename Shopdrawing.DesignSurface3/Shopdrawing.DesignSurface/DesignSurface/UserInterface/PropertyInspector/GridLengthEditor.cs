...
namespace Microsoft.Expression.DesignSurface.UserInterface.PropertyInspector
{
  ...
  public sealed class GridLengthEditor : Grid, INotifyPropertyChanged, IComponentConnector
  {
    ...
    {
      this.editingProperty.SetValue(((SceneNodeProperty) this.editingProperty).SceneNodeObjectSet.ViewModel.DefaultView.ConvertFromWpfValue((object) new GridLength(this.value, this.gridUnitType)));
    }
    ...
    public void InitializeComponent()
    {
      ...
      Application.LoadComponent((object) this, new Uri("/Microsoft.Expression.DesignSurface;component/userinterface/propertyinspector/complexvalueeditors/gridlengtheditor.xaml", UriKind.Relative));
    }
