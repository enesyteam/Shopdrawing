  ...
  public class SilverlightNumberEditor : NumberEditor
  {
    ...
    protected override ITypeDescriptorContext TypeDescriptorContext
    {
      get
      {
        ...
        {
          PropertyReferenceProperty referenceProperty = propertyValue.ParentProperty as PropertyReferenceProperty;
          if (referenceProperty != null)
          {
            IProjectContext projectContext = referenceProperty.ObjectSet.ProjectContext;
            if (projectContext != null)
            {
              ConverterContext converterContext = new ConverterContext((object) this);
    ...
    internal void CanExecuteClearPropertyValueCommand(object sender, CanExecuteRoutedEventArgs args)
    {
      bool flag = false;
      Microsoft.Windows.Design.PropertyEditing.PropertyValue propertyValue = this.DataContext as Microsoft.Windows.Design.PropertyEditing.PropertyValue;
      if (propertyValue != null && propertyValue.ParentProperty is SceneNodeProperty)
        flag = true;
