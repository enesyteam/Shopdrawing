      ...
      if (typeof (string).IsAssignableFrom(targetType))
      {
        ...
        if (propertyValue != null)
        {
          if (propertyValue.Value != null)
            return (object) (propertyValue.ParentProperty.DisplayName + " " + propertyValue.Value.GetType().Name);
          return (object) (propertyValue.ParentProperty.DisplayName + (object) " " + (string) (object) propertyValue.ParentProperty.PropertyType);
        }
      }
